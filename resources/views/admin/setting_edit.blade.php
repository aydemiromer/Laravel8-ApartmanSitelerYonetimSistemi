            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#smtp"  data-toggle="tab">Smtp</a>
                        </li>
                        <li class=""><a href="#social"  id="Social"  data-toggle="tab">Social Media</a>
                        </li>
                        <li class=""><a href="#about2" data-toggle="tab">About us</a>
                        </li>
                        <li class=""><a href="#contact2" data-toggle="tab">Contact</a>
                        </li>
