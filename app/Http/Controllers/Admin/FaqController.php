...
class FaqController extends Controller
{
    ...
    public function update(Request $request, Faq $faq,$id)
    {
        ...
        $data->status = $request->input('status');
        $data->save();
        return redirect() -> route('admin_faq')->with('success','Frequently Asked Question Uptaded');
    }
    ...
    public function destroy(Faq $faq,$id)
    {
        ...
        return redirect() -> route('admin_faq')->with('success','Frequently Asked Question Deleted');;
    }
}
